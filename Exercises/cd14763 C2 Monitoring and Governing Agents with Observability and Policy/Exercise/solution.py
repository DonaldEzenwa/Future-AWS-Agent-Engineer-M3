"""
================================================================================
WanderBot — EXERCISE SOLUTION: AgentCore Native Observability
================================================================================
Reference solution for the L11 exercise. Wires up WanderBot with two tools,
deploys to AgentCore Runtime, and makes every invocation visible in the
CloudWatch GenAI Observability Dashboard — courtesy of aws-opentelemetry-distro.
...
----------
  ...
  Then open: CloudWatch -> Bedrock -> GenAI Observability -> Sessions
================================================================================
"""
...
async def invoke(payload: dict, context=None) -> dict:
    """WanderBot — observability solution entry point."""
