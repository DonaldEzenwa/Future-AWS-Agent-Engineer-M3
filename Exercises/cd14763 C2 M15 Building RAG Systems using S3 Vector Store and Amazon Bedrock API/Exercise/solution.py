"""
================================================================================
WanderBot — EXERCISE SOLUTION: RAG with Amazon Bedrock Knowledge Bases
================================================================================
"""
...
# Step 3: Paste your KB ID here (from Step 2 — Console)
KB_ID  = "PASTE_YOUR_KB_ID_HERE"
REGION = "us-east-1"
_bedrock_runtime = boto3.client("bedrock-agent-runtime", region_name=REGION)


# Step 3: Custom @tool wrapping the Bedrock retrieve API
@tool
...
# Step 4: Entry point — wire up the agent with the RAG tool
@app.entrypoint
